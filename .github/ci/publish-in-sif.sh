...
# (project=scitex-dataset, owner=ywatanabe1989, repo=scitex-dataset,
...
TMPDIR="/tmp/publish-scitex_dataset-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-dataset dist/* uploaded to PyPI via manual OIDC trusted publishing"
