#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File: /home/ywatanabe/proj/scitex-dataset/tests/examples/test_02_search_datasets.py

"""Smoke test for examples/02_search_datasets.py.
...
EXAMPLE = Path(__file__).resolve().parents[2] / "examples" / "02_search_datasets.py"
