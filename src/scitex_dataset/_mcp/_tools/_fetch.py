...
def register_fetch_tools(mcp) -> None:
    ...
    @mcp.tool()
    def dandi_fetch(max_datasets: int = 100) -> List[Dict[str, Any]]:
    ...
    @mcp.tool()
    def physionet_fetch(max_datasets: int = 100) -> List[Dict[str, Any]]:
    ...
    @mcp.tool()
    def openml_fetch(max_datasets: int = 100) -> List[Dict[str, Any]]:
    ...
    @mcp.tool()
    def moleculenet_fetch(max_datasets: int = 100) -> List[Dict[str, Any]]:
    ...
    @mcp.tool()
    def geo_fetch(max_datasets: int = 100) -> List[Dict[str, Any]]:
    ...
    @mcp.tool()
    def chembl_fetch(max_datasets: int = 100) -> List[Dict[str, Any]]:
    ...
    @mcp.tool()
    def clinicaltrials_fetch(max_datasets: int = 100) -> List[Dict[str, Any]]:
