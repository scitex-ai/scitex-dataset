...
SOURCE_INFO = {
    ...
    "gin": {
        "name": "GIN (G-Node Infrastructure)",
        "description": "Neuroscience datasets behind a Gogs-style REST API + git-annex blob store (iEEG, ephys, behaviour)",
        "url": "https://gin.g-node.org",
        "format": "NIX / HDF5 / various",
        "domain": "neuroscience",
        "kind": "catalog",
    },
    "zenodo": {
